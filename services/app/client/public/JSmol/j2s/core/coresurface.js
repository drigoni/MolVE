...
case 0x1:
faces = JU.Triangulator.friezeEdge;
break;
case 0x4:
faces = JU.Triangulator.rodEdge;
break;
case 0x3:
...
c$.rodEdge =  Clazz_newArray(-1, [ Clazz_newIntArray(-1, [0, 3, 0, 1])]);
c$.friezeEdge =  Clazz_newArray(-1, [ Clazz_newIntArray(-1, [0, 1, 0, 1])]);
...
;//5.0.1-v4 Fri Oct 11 09:37:15 CDT 2024
Clazz_declarePackage("JU");
